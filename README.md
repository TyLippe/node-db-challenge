...
1. Explain the difference between `Relational Databases` and `SQL`.
    ...
    A relational database is a software used to create tables, SQL is the language we use to create tables.

1. Why do tables need a `primary key`?
    
    All tables need a primary key, this is usally our id, we can do this in JS with increment().
...
1. What do we need in order to have a _many to many_ relationship between two tables.
    ...
    To have a many to many we need a third table, for example a recipie table -> ingredient table -> quanitity table
